...
function (_React$Component) {
  ...
  function VideoPlayer() {
    ...
    _defineProperty(_assertThisInitialized(_this), "videoJsFallback", function () {
      return import('./chunk-6404bfd3.js').then(_this.youtubeFallback);
    });

    _defineProperty(_assertThisInitialized(_this), "youtubeFallback", function () {
      import('./chunk-3e450121.js').then(function () {
        _this.instantiate();
      });
    });
